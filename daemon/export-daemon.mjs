...
//
// PR #62 review (2026-07-05): moved from core/ to daemon/ so the "the
// evaluator never gains network capability" guarantee is a STRUCTURAL
// (directory-level) fact, not just a source-scan test / naming convention.
// core/ is evaluator-accessible, published, sandboxed code; daemon/ is a
// separate, unsandboxed, opt-in-only process tree the evaluator never loads.
//
